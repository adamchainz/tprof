...
static PyObject *
segment_begin(PyObject *module, PyObject *code, PyObject *non_target_result)
{
...
py_start_callback(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    return segment_begin(module, args[0], state->monitoring_disable);
}
...
py_throw_callback(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    return segment_begin(module, args[0], Py_None);
}
